...
def eval(args):
    ...
    env = gym.make("PyFlyt/QuadX-Hover-v1",render_mode="human")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--environment', '-env', type=str, default="PyFlyt/QuadX-Hover-v1", help='which environment to train on')
